...
class PhotoViewGalleryScreen extends StatefulWidget {
  ...
  PhotoViewGalleryScreen({Key key,@required this.images,this.index,this.controller,this.heroTag="simple"}) : super(key: key){
...
class _PhotoViewGalleryScreenState extends State<PhotoViewGalleryScreen> {
  ...
  void initState() {
    ...
    print("获取参数${widget.images}");
    print("获取参数1${widget.index}");
    super.initState();
