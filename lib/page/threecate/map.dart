...
class _MapChoicePointState extends State<MapChoicePoint>
  ...
  Future _openModalBottomSheet() async {
    ...
    if (option != null) {
      ...
      //将地图中心点移动到选择的点
      _amapController.setCenterCoordinate(LatLng(selectlatlng.latitude, selectlatlng.longitude));
      //删除原来地图上搜索出来的点
          ...
          child: AmapView(
            ...
            onMapCreated: (controller) async {
              ...
              if (await _requestPermission()) {
                ...
                //显示自己的定位
                await controller.showMyLocation(MyLocationOption(show: true,strokeColor: Colors.black));
                // await initSerach();
              }
            },
          ),
